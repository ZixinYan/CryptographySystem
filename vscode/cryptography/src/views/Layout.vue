...
<template>
    <el-container class="layout-container">
        ...
        <el-aside width="200px">
            ...
            <el-menu active-text-color="#ffd04b" background-color="#232323"  text-color="#fff"
                ...
                <el-sub-menu index="1">
                    ...
                    <el-menu-item index="/single/caesar">
                      <el-icon>
                            <Lock />
                        </el-icon>
                        <span>Caesar</span>
                      </el-menu-item>
                    <el-menu-item index="/single/affine">
                      <el-icon>
                            <Lock />
                        </el-icon>
                        <span>Affine</span>
                    </el-menu-item>
                    <el-menu-item index="/single/vigenere">
                      <el-icon>
                            <Lock />
                        </el-icon>
                        <span>Vigenere</span>
                    </el-menu-item>
                    <el-menu-item index="/single/autokey">
                      <el-icon>
                            <Lock />
                        </el-icon>
                        <span>Autokey</span>
                    </el-menu-item>
                    <el-menu-item index="/single/playfair">
                      <el-icon>
                            <Lock />
                        </el-icon>
                        <span>Playfair</span>
                    </el-menu-item>
                    <el-menu-item index="/single/permutation">
                      <el-icon>
                            <Lock />
                        </el-icon>
                        <span>Permutation</span>
                    </el-menu-item>
                    <el-menu-item index="/single/columnpermutation">
                      <el-icon>
                            <Lock />
                        </el-icon>
                        <span>C_Permutation</span>
                    </el-menu-item>
                    <el-menu-item index="/single/RC4">
                      <el-icon>
                            <Lock />
                        </el-icon>
                        <span>RC4</span>
                    </el-menu-item>
                    <el-menu-item index="/single/DES">
                      <el-icon>
                            <Lock />
                        </el-icon>
                        <span>DES</span>
                    </el-menu-item>
                    <el-menu-item index="/single/rsa">
                      <el-icon>
                            <Lock />
                        </el-icon>
                        <span>RSA</span>
                ...
                <el-sub-menu index="2">
                  <template #title>
                    ...
                    <el-menu-item index="/signature/ECC">
                      <el-icon>
                            <Lock />
                        </el-icon>
                        <span>ECC</span>
        ...
        <el-container>
            ...
            <el-footer>加密工具 ©2024 Created by zx</el-footer>
        </el-container>
    </el-container>
</template>
