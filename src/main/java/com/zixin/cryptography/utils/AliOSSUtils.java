package com.zixin.cryptography.utils;
...
public class AliOSSUtils {
    ...
    public static String uploadFile(String objectName, InputStream in) throws Exception {
        ...
        try {
            ...
            PutObjectRequest putObjectRequest = new PutObjectRequest(BUCTKET_NAME, objectName, in);
            ...
            url = "https://" + BUCTKET_NAME + "." + ENDPOINT.substring(ENDPOINT.lastIndexOf("/") + 1) + "/" + objectName;
